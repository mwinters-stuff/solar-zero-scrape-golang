...
func (_c *SolarZeroScrape_AuthenticateFully_Call) RunAndReturn(run func() bool) *SolarZeroScrape_AuthenticateFully_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *SolarZeroScrape_CurrentData_Call) RunAndReturn(run func() jsontypes.CurrentData) *SolarZeroScrape_CurrentData_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *SolarZeroScrape_DayData_Call) RunAndReturn(run func() jsontypes.DayData) *SolarZeroScrape_DayData_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *SolarZeroScrape_GetData_Call) RunAndReturn(run func() bool) *SolarZeroScrape_GetData_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *SolarZeroScrape_Healthy_Call) RunAndReturn(run func() bool) *SolarZeroScrape_Healthy_Call {
	_c.Call.Return(run)
	return _c
}

// MonthData provides a mock function with given fields:
func (_m *SolarZeroScrape) MonthData() jsontypes.DayData {
	ret := _m.Called()
...
func (_c *SolarZeroScrape_MonthData_Call) Return(_a0 jsontypes.DayData) *SolarZeroScrape_MonthData_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *SolarZeroScrape_MonthData_Call) RunAndReturn(run func() jsontypes.DayData) *SolarZeroScrape_MonthData_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *SolarZeroScrape_Ready_Call) RunAndReturn(run func() bool) *SolarZeroScrape_Ready_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *SolarZeroScrape_Start_Call) RunAndReturn(run func()) *SolarZeroScrape_Start_Call {
	_c.Call.Return(run)
	return _c
}

// YearData provides a mock function with given fields:
func (_m *SolarZeroScrape) YearData() jsontypes.DayData {
	ret := _m.Called()
...
func (_c *SolarZeroScrape_YearData_Call) Return(_a0 jsontypes.DayData) *SolarZeroScrape_YearData_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *SolarZeroScrape_YearData_Call) RunAndReturn(run func() jsontypes.DayData) *SolarZeroScrape_YearData_Call {
	_c.Call.Return(run)
	return _c
}
...
func NewSolarZeroScrape(t interface {
	mock.TestingT
	Cleanup(func())
}) *SolarZeroScrape {
